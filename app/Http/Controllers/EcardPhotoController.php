    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if ($request->hasFile('sample_image')) {
                $input['sample_image'] = Storage::put('upload/ecard/sample', $request->file('sample_image'));
                $input['sample_image'] = str_replace('upload/ecard/sample/', '', $input['sample_image']);
            }

            if ($request->hasFile('blank_image')) {
                $input['blank_image'] = Storage::put('upload/ecard/blank', $request->file('blank_image'));
                $input['blank_image'] = str_replace('upload/ecard/blank/', '', $input['blank_image']);
            }
