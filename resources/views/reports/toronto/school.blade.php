			...
			<tbody>
				<tr id="school-data">
					...
					<td>
						...
						-->
						<div>
							<p><strong>Name:</strong> {{ !empty($school[$i]->SCHOOL_NAME) ? $school[$i]->SCHOOL_NAME : 'N/A' }}</p>
							<p><strong>Address:</strong> {{ !empty($school[$i]->SCHOOL_PHYSICAL_ADDRESS) ? $school[$i]->SCHOOL_PHYSICAL_ADDRESS : 'N/A' }}</p>
							<div>
								...
								<span style="vertical-align:top;"><strong style="vertical-align:top;">Distance to house:</strong> {{ !empty($school[$i]->distance) ? round($school[$i]->distance, 2).'KM'  : 'N/A' }}</span>
							</div>
						</div>
					</td>
					@endfor
