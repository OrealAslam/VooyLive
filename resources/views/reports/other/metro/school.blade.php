<div class="row">
    <div class="col-lg-5 col-md-5 col-sm-5">
        <div class="left-side colora">
            {{__('reports/other/metro/school.publicSchools')}}
        </div>
    </div>
                ...
                <div class="row item school1">
                    <div class="school-head icon backgrounde">
                        ...
                        <span class="school-title colorb">
                            {{__('reports/other/metro/school.elementary')}}
                        </span>
                    </div>
                    <div class="info">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="school-name color-black" id="el_name">
                                    {{ !empty($elementarySchool->name) ? $elementarySchool->name : 'N/A' }}
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="school-address color-black" id="el_address">
                                    {{ !empty($elementarySchool->address) ? $elementarySchool->address : 'N/A' }}
                                </div>
                                <div class="school-grades color-black"><strong>{{__('reports/other/metro/school.grade')}}</strong>
                                    <div id="el_grade">
                                        <span>{{ !empty($elementarySchool->grade) ? $elementarySchool->grade : 'N/A' }}</span>
                                    </div>
                                </div>
                                <div class="school-distance color-black">
                                    ...
                                    <span class="walk-man-text2" style="display:inline;"><strong>{{__('reports/other/metro/school.distance')}}</strong></span>
                                    <span class="walk-man-text2" style="display:inline;" id="el_distance">
                                        {{ !empty($elementarySchool->distance) ? round($elementarySchool->distance, 2).'KM'  : 'N/A' }}
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="row item school2">
                    <div class="school-head icon backgrounde">
                        ...
                        <span class="school-title colorb">
                            {{__('reports/other/metro/school.juniorHigh')}}
                        </span>
                    </div>
                    <div class="info">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="school-name color-black" id="ju_name">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="school-address color-black" id="ju_address">
                                    {{ !empty($juniorSchool->address) ? $juniorSchool->address : 'N/A' }}
                                </div>
                                <div class="school-grades color-black"><strong>{{__('reports/other/metro/school.grade')}}</strong>
                                    <div id="ju_grade">
                                        <span>{{ !empty($juniorSchool->grade) ? $juniorSchool->grade : 'N/A' }}</span>
                                    </div>
                                </div>
                                <div class="school-distance color-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 470.642 470.642" style="enable-background:new 0 0 470.642 470.642;" xml:space="preserve" class="filla walk-man">
                                    ...
                                    <span class="walk-man-text2" style="display:inline;"><strong>{{__('reports/other/metro/school.distance')}}</strong></span>
                                    <span class="walk-man-text2" style="display:inline;" id="ju_distance">
                                        {{ !empty($juniorSchool->distance) ? round($juniorSchool->distance, 2).'KM'  : 'N/A' }}
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="row item school2">
                    <div class="school-head icon backgrounde">
                        ...
                        <span class="school-title colorb">
                            {{__('reports/other/metro/school.seniorHigh')}}
                        </span>
                    </div>
                    <div class="info">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="school-name color-black" id="se_name">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="school-address color-black" id="se_address">
                                    {{ !empty($highSchool->address) ? $highSchool->address : 'N/A' }}
                                </div>
                                <div class="school-grades color-black"><strong>{{__('reports/other/metro/school.grade')}}</strong>
                                    <div id="se_grade">
                                        <span>{{ !empty($highSchool->grade) ? $highSchool->grade : 'N/A' }}</span>
                                    </div>
                                </div>    
                                <div class="school-distance color-black">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 470.642 470.642" style="enable-background:new 0 0 470.642 470.642;" xml:space="preserve" class="filla walk-man">
                                    ...
                                    <span class="walk-man-text2" style="display:inline;"><strong>{{__('reports/other/metro/school.distance')}}</strong></span>
                                    <span class="walk-man-text2" style="display:inline;" id="se_distance">
                                        {{ !empty($highSchool->distance) ? round($highSchool->distance, 2).'KM'  : 'N/A' }}
                                    </span>
