                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row">
                                <div class="school-address color-black">
                                    {{ !empty($elementerySchool->address) ? $elementerySchool->address : 'N/A' }}
                                </div>
                                <div class="school-grades color-black">
                                    <strong>Grade:</strong><br>
                                    <span>{{ !empty($elementerySchool->grades_offered) ? $elementerySchool->grades_offered : 'N/A' }}</span>
                                </div>
                                <div class="school-distance color-black">
                                    ...
                                    <span class="walk-man-text2">
                                        <strong>Distance:</strong>{{ !empty($elementerySchool->distance) ? round($elementerySchool->distance, 2).'KM'  : 'N/A' }}
                                    </span>
                                </div>
                            </div>
                        </div>
