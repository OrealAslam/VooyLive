                        ...
                        <div class="transport-distance color-black">
                            <div class="distance-container">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color-black">Distance</strong>: {{ (!empty($bus_station) && !empty($bus_station['distance'])) ? round($bus_station['distance'], 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info">
                        ...
                        <div class="transport-distance color1">
                            <div class="distance-container">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color-black">Distance</strong>: {{ (!empty($train_station) && !empty($train_station['distance'])) ? round($train_station['distance'], 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
