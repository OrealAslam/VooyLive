    ...
    <div class="col-lg-7 col-md-7 col-sm-7">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                    <div class="backgroundd col-lg-4 col-md-4 col-sm-4">
                    ...
                    <div class="backgrounde col-lg-4 col-md-4 col-sm-4">
                        <div class="row row-eq-height">
                            <div class="item vcenter">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="row">
                    ...
                    <div class="backgroundd col-lg-4 col-md-4 col-sm-4">
                        <div class="row row-eq-height">
                            <div class="item vcenter" style="padding-left: 16px; padding-right:16px;">
                                <div class="icon color-white">
