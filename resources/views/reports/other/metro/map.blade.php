                            ...
                            <div class="backgroundd item vcenter">
								...
								<div class="distance color-white">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;"><strong class="color-white">Distance</strong>:</span>
										<span class="walk-man-text1" style="display:inline;" id="res_one_distance"> 
											{{App\Report::checkEmptyValue(round($response['resturants'][0]['distance'], 2))}}KM
										</span>
									</div>
								</div>
								...
								<div class="distance color-white">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="res_two_distance"> 
											{{App\Report::checkEmptyValue(round($response['resturants'][1]['distance'], 2))}}KM
										</span>
									</div>
								</div>
                            </div>
                            ...
                            <div class="backgrounde item vcenter">
								...
								<div class="distance color-black">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;"><strong class="color-black">Distance</strong>:</span>
										<span class="walk-man-text1" style="display:inline;" id="bank_one_distance"> 
											{{App\Report::checkEmptyValue(round($response['banks'][0]['distance'], 2))}}KM
										</span>
									</div>
								</div>
								<div class="margin-10"></div>											
								...
								<div class="distance color-black">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="bank_two_distance"> 
											{{App\Report::checkEmptyValue(round($response['banks'][1]['distance'], 2))}}KM
										</span>
									</div>
								</div>			
								@else
								...
								<div class="distance color-white">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="store_one_distance"> 
											{{App\Report::checkEmptyValue(round($response['conStores'][0]['distance'], 2))}}KM
										</span>
									</div>
								</div>
								<div class="margin-10"></div>											
								...
								<div class="distance color-white">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="store_two_distance"> 
											{{App\Report::checkEmptyValue(round($response['conStores'][1]['distance'], 2))}}KM
										</span>
									</div>
								</div>											
                            </div>
								...
								<div class="distance color-black">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="gas_one_distance">
											{{App\Report::checkEmptyValue(round($response['gasstations'][0]['distance'], 2))}}KM
										</span>
									</div>
								</div>
								<div class="margin-10"></div>											
								...
								<div class="distance color-black">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="gas_two_distance">
											{{App\Report::checkEmptyValue(round($response['gasstations'][1]['distance'], 2))}}KM
										</span>
									</div>
								</div>											
                            </div>
								...
								<div class="distance color-white">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="cafe_one_distance"> 
											{{App\Report::checkEmptyValue(round($response['cafe'][0]['distance'], 2))}}KM
										</span>
									</div>
								</div>
								<div class="margin-10"></div>
								...
								<div class="distance color-white">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="cafe_two_distance"> 
											{{App\Report::checkEmptyValue(round($response['cafe'][1]['distance'], 2))}}KM
										</span>
									</div>
								</div>										
                            </div>
								...
								<div class="distance color-black">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="gym_one_distance"> 
											{{App\Report::checkEmptyValue(round($response['gym'][0]['distance'], 2))}}KM
										</span>
									</div>
								</div>
								<div class="margin-10"></div>
								...
								<div class="distance color-black">
									<div class="distance-container">
										...
										<span class="walk-man-text1" style="display:inline;" id="gym_two_distance"> 
											{{App\Report::checkEmptyValue(round($response['gym'][1]['distance'], 2))}}KM
										</span>
									</div>
								</div>										
                            </div>
