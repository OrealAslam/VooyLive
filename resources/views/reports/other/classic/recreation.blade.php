	...
	<table class="table table-bordered">
		<tr>
			...
			<td class="col-xs-7 text-center">
				<p style="display:inline;"><strong>Name:</strong></p> <p style="display:inline;" id="re_name">{{ !empty($response->name) ? $response->name : 'N/A' }}</p><br><br>
				<p style="display:inline;"><strong>Type:</strong></p> <p style="display:inline;" id="re_type">{{ !empty($response->type) ? $response->type : 'N/A' }}</p><br><br>
					<div>
						...
						<span style="display:inline;"><strong style="vertical-align:top;">Distance to house:</strong></span> <span style="vertical-align:top;display:inline;" id="re_distance">{{ !empty($response->distance) ? round($response->distance, 2).'KM'  : 'N/A' }}</span>
					</div>
			</td>
		</tr>
	</table>
