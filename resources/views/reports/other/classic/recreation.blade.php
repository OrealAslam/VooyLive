<div class="section-title">
	<h3 class="colora text-center">{{__('reports/other/classic/recreation.recreation')}}</h3>
	...
	<table class="table table-bordered">
		<tr>
			...
			<td class="col-xs-7 text-center">
				<p style="display:inline;"><strong>{{__('reports/other/classic/recreation.name')}}</strong></p> <p style="display:inline;" id="re_name">{{ !empty($response->name) ? $response->name : 'N/A' }}</p><br><br>
				<p style="display:inline;"><strong>{{__('reports/other/classic/recreation.type')}}</strong></p> <p style="display:inline;" id="re_type">{{ !empty($response->type) ? $response->type : 'N/A' }}</p><br><br>
					<div>
						...
						<span style="display:inline;"><strong style="vertical-align:top;">{{__('reports/other/classic/recreation.distanceToHouse')}}</strong></span> <span style="vertical-align:top;display:inline;" id="re_distance">{{ !empty($response->distance) ? round($response->distance, 2).'KM'  : 'N/A' }}</span>
					</div>
			</td>
		</tr>
	</table>
