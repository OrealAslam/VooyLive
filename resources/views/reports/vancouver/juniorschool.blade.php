<div class="col-xs-12">
	...
	<div class="row text-center">
		<p><strong>Name:</strong> {{ $juniorSchools->school_name }}</p>
		<p><strong>Address:</strong> {{ $juniorSchools->address }}</p>
		<p><strong>Grade:</strong> {{ $juniorSchools->grades_offered }}</p>
		<div>
			...
			<span style="vertical-align:top;"><strong>Distance to house:</strong> {{ round($juniorSchools->distance, 2) }}KM</span>
		</div>
	</div>
</div>