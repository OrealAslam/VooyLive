		...
		<tr>
			@foreach($response as $res)
				...
				<td class="col-xs-2 text-center" style="vertical-align: middle;">
					<div class="fillb" style="">
						<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							 viewBox="0 0 512.001 512.001" width="64px" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
						<g>
							<g>
				...
				<td class="col-xs-4 text-center">
						<p><strong>Name:</strong> {{ !empty($res->centre_name) ? $res->centre_name : 'N/A' }}</p>
