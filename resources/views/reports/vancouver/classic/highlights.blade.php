				...
				<div class="row" id="highlightreport">
					<div class="col-xs-12" id="apisContainer">
						...
						<div id="footer" class="row backgroundc" @if(isset($user->ClientDetail->colora)) style="border-color: {{$user->ClientDetail->colora}}" @endif>
							<div class="col-xs-12 col-md-4 col-pdf-4">
								...
								<div class="row">
									<div class="col-xs-4 col-custom-6">
										<div class="">
		                                    ...
		                                    @else
		                                        <a href="{{ url('/account/profileview').'?img=profile' }}" class="img-information" title="Click Here to Upload Image"> <img src="/img/your-image-here.png" class="img-responsive" style="width: 100px; height: 144px"></a>
		                                    @endif
										</div>
									</div>
							...
							<div class="col-xs-12 col-md-8 col-pdf-8">
								<div class="row">
