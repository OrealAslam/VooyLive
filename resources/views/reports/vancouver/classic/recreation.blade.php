	...
	<table class="table table-bordered">
		<tr>
			...
			<td class="col-xs-7 text-center">
				<p><strong>Name:</strong> {{ !empty($recreation[0]->cultural_space_name) ? $recreation[0]->cultural_space_name : 'N/A' }}</p>
				<p><strong>Type:</strong> {{ !empty($recreation[0]->primary_use) ? $recreation[0]->primary_use : 'N/A' }}</p>
				<p><strong>Address:</strong> {{ !empty($recreation[0]->address) ? $recreation[0]->address : 'N/A' }}</p>
					<div>
						...
						<span style="vertical-align:top;"><strong style="vertical-align:top;">Distance to house:</strong> {{ !empty($recreation[0]->distance) ? round($recreation[0]->distance, 2).'KM'  : 'N/A' }}</span>
					</div>
			</td>
		</tr>
	</table>
