				...
				<div>
					<div class="demographics-icon icon-before-title">
						<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							 viewBox="0 0 512 512" width="50px" class="fillf" style="enable-background:new 0 0 512 512;" xml:space="preserve">
						<g>
							<g>
					...
					<div class="demographics-title colord text-after-icon">Culture</div>
				</div>
				<br>
				@php $counter = 1; @endphp
