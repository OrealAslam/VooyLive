...
<link href="/css/metroReport/vancouver-style.css" rel="stylesheet" type="text/css">

<link href="/css/metroReport/print.css" rel="stylesheet" media="print" type="text/css">
<link href="/css/metroReport/vancouver-print.css" rel="stylesheet" media="print" type="text/css">
...
<div class="container" id="features">
    ...
    <div class="header section font-raleway" id="header">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 address head-address text-editable" data-field-id="custom_report_address">
