        ...
        <div class="row">
                ...
                <div class="row item">
                    ...
                    <div class="info">
                        <div class="transport-name">
                            {{ (!empty($bus_data) && !empty($bus_data[0]['name'])) ? $bus_data[0]['name'] : 'N/A' }}
                        </div>
                        <!--
                        <div class="transport-address">
                            {{-- (!empty($bus_data[0]) && !empty($bus_data[0]->stop_name)) ? $bus_data[0]->stop_name : 'N/A' --}}
                        </div>
                        -->
                        <div class="transport-distance color-black">
                            <div class="distance-container">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color-black">Distance</strong>:  {{ (!empty($bus_data) && !empty($bus_data[0]['distance'])) ? round($bus_data[0]['distance'], 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="row item train-item">
                    ...
                    <div class="info">
                        <div class="transport-name">
                            {{ (!empty($lrt_data) && !empty($lrt_data[0]['name'])) ? $lrt_data[0]['name'] : 'N/A' }}
                            @if (!empty($lrt_data) && !empty($lrt_data[0]['vicinity']))
                                {{ ', '. $lrt_data[0]['vicinity'] }}
                            @endif
                        </div>
                        <div class="transport-distance color-black">
                            <div class="distance-container">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color-black">Distance</strong>:  {{ (!empty($lrt_data) && !empty($lrt_data[0]['distance'])) ? round($lrt_data[0]['distance'], 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
