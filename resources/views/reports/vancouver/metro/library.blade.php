            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="row">
                    <div class="library-address">
                        <div>
                        {{ (!empty($library) && !empty($library[0]->branch_name)) ? $library[0]->branch_name : 'N/A' }}<br>
                        {{ (!empty($library) && !empty($library[0]->physical_address)) ? $library[0]->physical_address : 'N/A' }}<br>
                        </div>
                        <div class="distance-container">
                            ...
                            <span class="walk-man-text2">
                                <strong class="color1">Distance</strong>: {{ (!empty($library) && !empty($library[0]->distance)) ? round($library[0]->distance, 2).'KM'  : 'N/A' }}
                            </span>
                        </div>  
                    </div>
                </div>
