		...
		<div class="container">
			<div class="col-xs-12 report-header" id="content" @if(isset($user->ClientDetail->colorc)) style="border-color: {{$user->ClientDetail->colorc}}" @endif>
							...
							<thead>
								<tr>
									<td class="col-xs-9 report-address colora text-center text-editable" style="vertical-align: middle;" data-field-id="custom_report_address">
                      					<h3 class="content addressText">{{ !empty($orderData->custom_report_address) ? $orderData->custom_report_address : $report->address }}</h3>
									</td>
									<td class="col-xs-3">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						<div id ="demography_safety" class="row" @if(isset($user->ClientDetail->colorc)) style="border-color: {{$user->ClientDetail->colorc}}" @endif>
							<div class="col-xs-6 colorc" id="demography">
								@if($demography!=null)
								{!! $demography !!}
								@else
									<script type="text/javascript">
							...
							<div class="col-xs-6 colorc" id="safety">
								@if($safety!=null)
								{!! $safety !!}
								@else
									<script type="text/javascript">
					...
					<div class="col-xs-12 colorc report-inner-border" id="waste" @if(isset($user->ClientDetail->colorc)) style="border-color: {{$user->ClientDetail->colorc}}" @endif>
						@if($waste!=null)
						{!! $waste !!}
						@else
							<script type="text/javascript">
					...
					<div class="col-xs-12" id="apisContainer">
						...
						<div id="footer" class="row backgroundc" @if(isset($user->ClientDetail->colora)) style="border-color: {{$user->ClientDetail->colora}}" @endif>
							<div class="col-md-4 col-xs-12 col-pdf-4">
								...
								<div class="row">
									<div class="col-xs-4 col-custom-6">
										<div class="">
									...
									<div class="col-xs-8 col-custom-6" style="word-break:break-all !important;">
										<div class="pull-left">
	                                        @if(isset($user->ClientDetail->logo))
