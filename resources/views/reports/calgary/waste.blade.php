	...
	<div class="col-xs-12">
		<table class="table text-center table-bordered table-striped school-table">
			<tbody>
				<tr>
					<td class="col-xs-4">
						<div class="demographics-icon icon-before-title fillb">
						...
						<div class="demographics-title colorb text-after-icon">Blue Cart (Recycling)</div>
					</td>
					<td class="col-xs-4">
						<div class="demographics-icon icon-before-title fillb">
							<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						...
						<div class="demographics-title colorb text-after-icon">Black Cart (Garbage)</div>
					</td>
					<td class="col-xs-4">
						<div class="demographics-icon icon-before-title fillb">
						...
						<div class="demographics-title colorb text-after-icon">Green Cart (Compost)</div>
					</td>
				</tr>
				<tr>
					<td>
						...
						<div id="blue_cart">
							<div>
								...
								<span style="vertical-align:top;"><strong style="vertical-align:top;">Collection day:</strong> 
									@if (isset($waste_blue_cart) && isset($waste_blue_cart[0]) && isset($waste_blue_cart[0]->clect_da_dscrn_2017))
										{{$waste_blue_cart[0]->clect_da_dscrn_2017}}
									@else
										N/A
									@endif
								</span>
							...
							<div>
								...
								<span style="vertical-align:top;"><strong style="vertical-align:top;">Frequency:</strong>
									@if (isset($waste_blue_cart) && isset($waste_blue_cart[0]) && isset($waste_blue_cart[0]->wkly_freq_2017))
										{{$waste_blue_cart[0]->wkly_freq_2017}}
									@else
										N/A
									@endif
							</div>
					...
					<td>
						...
						<div id="black_cart">
							<div>
								...
								<span style="vertical-align:top;"><strong style="vertical-align:top;">Collection day:</strong> 
									@if (isset($waste_black_cart) && isset($waste_black_cart[0]) && isset($waste_black_cart[0]->clect_da_dscrn_2017))
										{{$waste_black_cart[0]->clect_da_dscrn_2017}}
									@else
										N/A
									@endif
								</span>
							...
							<div>
								...
								<span style="vertical-align:top;"><strong style="vertical-align:top;">Frequency:</strong>
									@if (isset($waste_black_cart) && isset($waste_black_cart[0]) && isset($waste_black_cart[0]->wkly_freq_2017))
										{{$waste_black_cart[0]->wkly_freq_2017}}
									@else
										N/A
									@endif
							</div>
					...
					<td>
						...
						<div id="green_cart">
							<div>
								...
								<span style="vertical-align:top;"><strong style="vertical-align:top;">Collection day:</strong> 
									@if (isset($waste_green_cart) && isset($waste_green_cart[0]) && isset($waste_green_cart[0]->clect_da_dscrn_2017))
										{{$waste_green_cart[0]->clect_da_dscrn_2017}}
									@else
										N/A
									@endif
								</span>
							...
							<div>
								...
								<span style="vertical-align:top;"><strong style="vertical-align:top;">Frequency:</strong>
									@if (isset($waste_green_cart) && isset($waste_green_cart[0]) && isset($waste_green_cart[0]->wkly_freq_2017))
										{{$waste_green_cart[0]->wkly_freq_2017}}
									@else
										N/A
									@endif
							</div>
