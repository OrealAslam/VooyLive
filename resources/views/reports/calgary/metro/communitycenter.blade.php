<div class="communitycenter-item-container">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row items item1">
                <div class="col-lg-1 col-md-1 col-sm-1">
                    <div class="row">
                        <div class="icon">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="fillf" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                                <metadata>
