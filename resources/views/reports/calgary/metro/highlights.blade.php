...
<link href="/css/metroReport/calgary-style.css" rel="stylesheet" type="text/css">

<link href="/css/metroReport/print.css" rel="stylesheet" media="print" type="text/css">
<link href="/css/metroReport/calgary-print.css" rel="stylesheet" media="print" type="text/css">
...
<style type="text/css">
    ...
    @media print{
        ...
        .head-address{
            padding:0px 0px 5px 00px !important;
...
<div class="container" id="features">
    ...
    <div class="header section font-raleway" id="header">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 head-address address text-editable" data-field-id="custom_report_address">
                <span class="colora content addressText">{{ !empty($orderData->custom_report_address) ? $orderData->custom_report_address : $report->address }}</span>
            </div>
        </div>
        <div class="row">
            <hr class="style1">
    ...
    <div class="demographics2 section font-raleway" id="demography">
		@if($demography!=null)
		{!! $demography !!}
		@else
			<script type="text/javascript">
    ...
    <div class="waste section font-raleway" id="waste">
        @if($waste!=null)
            {!! $waste !!}
        @else
            <script type="text/javascript">
                $.ajax({
                    url:'{{ url('/report/getApi/waste/'.$report->reportId) }}',
                    dataType:'html',
                    beforeSend:function(){
                        scripts++;
                    },
    ...
    <div class="safety section font-raleway pageBreakAfter" id="safety">
        @if($safety!=null)
        {!! $safety !!}
        @else
            <script type="text/javascript">
            $.ajax({
                url:'{{ url('/report/getApi/safety/'.$report->reportId) }}',
                dataType:'html',
                beforeSend:function(){
                    scripts++;
                },
    ...
    <!-- End of Page 1 -->
    <!-- Start of Page 2 -->
    <div class="page2-head section font-raleway" id="page2-head">
        <div class="row">
            <hr class="style4">
        </div>
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-md-9 col-sm-10">
                                <div class="colora order-visit text-center">
                                    ...
                                    <a href="{{url('/')}}" class="colora"><strong>www.vooymarketinginc.com</strong></a>
                                </div>
                            </div>
