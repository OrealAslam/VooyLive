        ...
        <div class="row">
                        ...
                        <div class="transport-distance color1">
                            <div class="distance-container">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color1">Distance</strong>: {{ (!empty($bus_data[0]) && !empty($bus_data[0]->distance)) ? round($bus_data[0]->distance, 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="row item train-item">
                    ...
                    <div class="info">
                        <div class="transport-name">
                            {{ (!empty($lrt_data) && !empty($lrt_data[0]->stationnam)) ? $lrt_data[0]->stationnam : 'N/A' }}
                            {{ (!empty($lrt_data) && !empty($lrt_data[0]->direction)) ? ', '.$lrt_data[0]->direction : '' }}
                        </div>
                        <div class="transport-distance color1">
                            <div class="distance-container">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 470.642 470.642" style="enable-background:new 0 0 470.642 470.642;" xml:space="preserve" class="filla walk-man">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color1">Distance</strong>: {{ (!empty($lrt_data) && !empty($lrt_data[0]->distance)) ? round($lrt_data[0]->distance, 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
