        ...
        <div class="row">
                ...
                <div class="row item">
                    ...
                    <div class="info">
                        <div class="transport-name">
                            {{ (!empty($response[0]) && !empty($response[0]->landmark_name)) ? $response[0]->landmark_name : 'N/A' }}
                        </div>
                        <div class="transport-address">
                            {{ (!empty($response[0]) && !empty($response[0]->address)) ? $response[0]->address : 'N/A' }}
                        </div>
                        <div class="transport-distance color-black">
                            <div class="distance-container">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color-black">Distance</strong>: {{ (!empty($response[0]) && !empty($response[0]->distance)) ? round($response[0]->distance, 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="row item train-item">
                    ...
                    <div class="info">
                        <div class="transport-name">
                             {{ (!empty($lrt_response) && !empty($lrt_response['station'])) ? $lrt_response['station'] : 'N/A' }}
                        </div>
                        <div class="transport-address">
                            {{ (!empty($lrt_response) && !empty($lrt_response['address'])) ? $lrt_response['address'] : 'N/A' }}
                        </div>
                        <div class="transport-distance color1">
                            <div class="distance-container">
                                ...
                                <span class="walk-man-text1">
                                    <strong class="color-black">Distance</strong>: {{ (!empty($lrt_response) && !empty($lrt_response['distance'])) ? round($lrt_response['distance'], 2).'KM'  : 'N/A' }}
                                </span>
                            </div>
                        </div>
                    </div>
