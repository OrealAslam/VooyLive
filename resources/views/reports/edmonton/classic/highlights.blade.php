							...
							<div class="col-md-8 col-xs-12 col-pdf-8">
								<div class="row">
									<div class="col-xs-10 pull-left">
										<h5 class="colora text-center">To order a {{ config('app.title') }}, visit <a href="{{url('https://www.vooymarketinginc.com/')}}" class="colora"><strong>www.vooymarketinginc.com</strong></a></h5>
									</div>
