        ...
        <div class="container">
			<div class="col-md-12">
				...
				<form action="{{ URL::Route('reportNotes', ['reportId'=>$reportId]) }}" method="post" class="report-notes-form" >
					...
					<div class="form-group">
						<label>Point 1 <span id="char_count1" style="color: green"></span></label>
					...
					<div class="form-group">
						<label>Point 2 <span id="char_count2" style="color: green"></span></label>
					...
					<div class="form-group">
						<label>Point 3 <span id="char_count3" style="color: green"></span></label>
					...
					<div class="form-group">
						...
						<a class="btn btn-default" href="{{route('reportDetails', ['reportId' => $reportId, 'userId' => $userId, 'template' => 'metro'])}}">Cancel / Go Back to Report</a>
					</div>
				</form>
			</div>
		</div>
