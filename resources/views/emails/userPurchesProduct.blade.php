			...
			<td style="padding:10px;">
				<div class="movableContent" style="border: 0px;padding-top: 0px;position: relative;margin: 0;">
					<ul style="list-style:none;margin:0px;padding: 0px;font-size:14px;">
						<li style="margin:0px;padding: 0px;">Product Name : {{ $productName }}</li>
						<li style="margin:0px;padding: 0px;">Address : {{ $address }}</li>
						<li style="margin:0px;padding: 0px;">Neighborhood : {{ $neighborhood }}</li>
					</ul>
					{!! $note !!}
				</div>
			</td>
	...
	<table class="table" style="width:100%;border:1px solid #d2d2d2;border-collapse: collapse;">
		...
		<tr>
			<td width="100%" style="display: none;">	
				<div style="width:102% !important; border-collapse: separate;">
					<tr style="width:100% !important;">
						<th style="padding:7px 15px;text-align:left;border:1px solid #d2d2d2;">File Name</th>
						<th style="padding:7px 15px;text-align:center;border:1px solid #d2d2d2;">Download</th>
					</tr>
					<tr style="width:100% !important;">
						@foreach($file as $k => $fileName)
							...
							<td style="text-align: center !important;border:1px solid #d2d2d2;" width="20%">
								<a href="{{ route('doc.download', ['file' => $fileName]) }}" style="color: #fff !important;background-color: #ea2349;border-radius:10px;padding:4px 8px;font-size:12px;text-decoration: none;" class="btn btn-primary">Download</a><br/>
							</td>
						@endforeach
					</tr>
				</div>
