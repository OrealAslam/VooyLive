			...
			<tr>
				<td align="left">
					<div class="contentEditableContainer contentTextEditable" style="margin: 0;">
						...
						<div class="contentEditable" align="center" style="margin: 0;">
							<h2 style="text-align: left;color: #222222;font-size: 19px;font-weight: normal;">Just a quick reminder that in {{$remainingDays}} days, your free trial will end {{ date('d/m/Y',strtotime($trialEndsAt)) }}. Your selected a plan will automatically begin.</h2>
						</div>
					</div>
				</td>
			</tr>
