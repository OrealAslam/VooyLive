            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-print-12">
                    <div class="para1 text-center colora text-editable" data-field-id="welcome">
                        <div class="content" data-placeholder="This home is listed for sale by {{!empty($user->firstName) || !empty($user->lastName) ? $user->firstName .' '. $user->lastName : ''}}, Realtor&reg; {{!empty($user_details->phone) ? $user_details->phone : ''}}">{!!$hdiData['welcome']!!}</div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-print-12">
                    <div class="head3 backgrounde colorb">
                        ...
                        <div class="neighborhood-text text-editable" data-field-id="neighborhood">
                            <div class="pull-left">NEIGHBORHOOD:&nbsp</div> <div class="content pull-left" data-placeholder="Enter Neighborhood">{!!$hdiData['neighborhood']!!}</div>
            ...
            <div class="row item-container">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-print-3">
                    <div class="item">
                        <div class="svg-icon-container">
                            <div class="svg-icon fillf bgcolor-white image-editable" data-img-name="items_{{$i}}_icons">
                                <div class="icon-content">
                                    {!!Storage::get($hdi_images['items_'.$i.'_icons'])!!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-block3 text-center backgroundd colorb text-editable" data-field-id="items_{{$i}}_text3">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-print-12">
                    <div class="schools">
                        <div class="schools-icon-container backgrounde">
                            <div class="col-lg-offset-5 col-lg-2 col-md-offset-5 col-md-2 col-sm-offset-5 col-sm-2 col-xs-offset-4 col-xs-5 col-print-offset-5 col-print-2 icon-container">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row-bg">
                                        <td class="text-editable" data-field-id="schools_{{$i}}_level">
                                            <div class="content" data-placeholder="Elementary">{!!$hdiData['schools_'.$i.'_level']!!}</div>
                                        </td>
                                        <td class="text-editable" data-field-id="schools_{{$i}}_name">
                                            <div class="content" data-placeholder="Bush Hill Elementary School">{!!$hdiData['schools_'.$i.'_name']!!}</div>
                                        </td>
                                        <td class="text-editable" data-field-id="schools_{{$i}}_grade">
                                            <div class="content" data-placeholder="PK-6">{!!$hdiData['schools_'.$i.'_grade']!!}</div>
                                        </td>
                                        <td class="text-editable" data-field-id="schools_{{$i}}_students">
                                            <div class="content" data-placeholder="472 Students">{!!$hdiData['schools_'.$i.'_students']!!}</div>
                                        </td>
                                    </tr>
                                    @endfor
                                </tbody>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-print-12">
                    <div class="para4 color4 text-center">
                        *School Information provided is intended to be used as reference only. To verify enrollment eligibility for a property, contact the school directly
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-print-4">
                    <div class="footerdiv2">
                        <div class="footerdiv2-container colora">
                            ...
                            <!--
                            <div class="footer_text text-editable" data-field-id="footer_text">
                                <div class="content" data-placeholder="3001 Washington Blvd. Suite 400 Arlington, VA 22201">{--!!$hdiData['footer_text']!!--}</div>
                            </div>
                        -->
                        </div>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Icon Gallery <i class="fa fa-spinner fa-spin hide loading" style="font-size:18px"></i></h4>
            </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="iconUpload">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Upload Icon <i class="fa fa-spinner fa-spin hide loading" style="font-size:18px"></i></h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary upload-icon-file">Upload <i class="fa fa-spinner fa-spin hide loading" style="font-size:18px"></i></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
        ...
        processHdi = {
            params: {
                ...
                rawData : {
                    ...
                    "items_0_icons" : "", "items_0_text1" : "", "items_0_text2" : "", "items_0_text3" : "",
                    "items_1_icons" : "", "items_1_text1" : "", "items_1_text2" : "", "items_1_text3" : "",
                    "items_2_icons" : "", "items_2_text1" : "", "items_2_text2" : "", "items_2_text3" : "",
                    "items_3_icons" : "", "items_3_text1" : "", "items_3_text2" : "", "items_3_text3" : "",
                    "items_4_icons" : "", "items_4_text1" : "", "items_4_text2" : "", "items_4_text3" : "",
                    "items_5_icons" : "", "items_5_text1" : "", "items_5_text2" : "", "items_5_text3" : "",
                    "items_6_icons" : "", "items_6_text1" : "", "items_6_text2" : "", "items_6_text3" : "",
                    "items_7_icons" : "", "items_7_text1" : "", "items_7_text2" : "", "items_7_text3" : "",
                    "items_8_icons" : "", "items_8_text1" : "", "items_8_text2" : "", "items_8_text3" : "",
                    "items_9_icons" : "", "items_9_text1" : "", "items_9_text2" : "", "items_9_text3" : "",
                    "items_10_icons" : "", "items_10_text1" : "", "items_10_text2" : "", "items_10_text3" : "",
                    "items_11_icons" : "", "items_11_text1" : "", "items_11_text2" : "", "items_11_text3" : "",

                    "schools_0_level" : "", "schools_0_name" : "", "schools_0_grade" : "", "schools_0_students" : "",
                    "schools_1_level" : "", "schools_1_name" : "", "schools_1_grade" : "", "schools_1_students" : "",
                    "schools_2_level" : "", "schools_2_name" : "", "schools_2_grade" : "", "schools_2_students" : "",
            ...
            events : function () {
                ...
                */
                $('#hdiContainer div.image-editable div.options').find('span.edit-img').unbind().on('click',function(){
                    //console.log($(this));
                    //console.log('adnan');
                    //that.focusEditImage($(this));
            ...
            preProcess : function () {
                ...
                */
                ...
                $('.image-editable').each(function( index, element ) {
                    ...
                    editOptionsHtmlForImage += '<span class="edit-img" data-img-name="'+data_img_name+'"><i class="fa fa-pencil"></i></span>';
            ...
            loadIconGallery : function () {
                ...
                $.ajax({
                    ...
                    data: { _token: "{{ csrf_token() }}", params : that.params.iconGalleryOptions},
                    beforeSend:function(){
            ...
            getIconsHtml : function (iconData) {
                ...
                html += '<input class="icon_checkbox" type="checkbox" name="" data-icon-id="icon_'+iconData.id+'" value="'+iconData.icon_file+'" />';
                html += '</div>';
                html += '</div>';
                html += '</div>';
                html += '</div>';
            ...
            renderIcons : function () {
                ...
                if (that.params.iconGalleryData && that.params.iconGalleryData.data && that.params.iconGalleryData.data.length > 0) {
                    ...
                    var navigationHtml = that.getNavigation(1, that.params.iconGalleryData.last_page, that.params.iconGalleryData.current_page);
                    ...
                    $('#iconGallery').find('.svg-icon-container').unbind().on('click', function() {
                        ...
                        $('input.icon_checkbox').not($(this).find('input.icon_checkbox')).prop('checked', false);
                    });
                    ...
                    $('#iconGallery .change-icon').unbind().on('click', function() {
                        if($('#iconGallery').find('.svg-icon-container').find('input.icon_checkbox:checked').length > 0) {
                            var icon_id = $('#iconGallery').find('.svg-icon-container').find('input.icon_checkbox:checked').attr('data-icon-id');
                            var icon_file = $('#iconGallery').find('.svg-icon-container').find('input.icon_checkbox:checked').val();
                    ...
                    $('#iconGallery .pagination .goto-page').unbind().on('click', function() {
                        that.params.iconGalleryOptions.current_page = $(this).attr('data-page');
                        that.loadIconGallery();
                        //that.uploadIcon();
                        //$('.item .svg-icon-container').find('div[data-img-name="'+that.params.iconToBeChange+'"]').find('div.icon-content').html(data.new_icon_data);
                    });
                ...
                $('#iconGallery #search_tag_btn').unbind().on('click', function() {
                    that.params.iconGalleryOptions.tag_id = $('#iconGallery #search_tag').val();
                    that.loadIconGallery();
                });
                                ...
                                if (data) {
                                    ...
                                    if (data.icon_update) {
                                        if (data.icon_update.status == 1) {
                                            toastr.success(data.icon_update.msg);
                                        } else {
