                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ env('AWS_URL').'upload/cartFile/'.$productDetail->custom_design_file_upload }}"
                                download>{{ $productDetail->custom_design_file_upload }}</a>
                            @endif
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="row">
                <div class="x_title">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="{{ route('user.product.detail.create',$id) }}" class="btn btn-success">Add Product
                            Details</a>
                    </div>
                    <div class="clearfix"></div>
                </div>
