...
<div class="container">
    ...
    <form action="{{ route('ecard.photo.update',$ecardPhoto->id) }}" method="post" class="col-lg-12" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control type-se" name="ecards_categories_id">
                        ...
                        @foreach ($ecardCategory as $key => $value)
                            <option value="{{ $value->id }}" {{ ($ecardPhoto->ecards_categories_id == $value->id ? "selected" : "") }}>{{ $value->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="title" placeholder="Enter Title.." class="form-control" value="{{ $ecardPhoto->title }}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="x_greeting_coordinate" placeholder="Enter X Greeting Coordinate" class="form-control x" value="{{ $ecardPhoto->x_greeting_coordinate }}">
                        </div>    
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-lable">Y Greeting Coordinate</label>
                            <input type="text" name="y_greeting_coordinate" placeholder="Enter Y Greeting Coordinate" class="form-control y" value="{{ $ecardPhoto->y_greeting_coordinate }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="x_solution_coordinate" placeholder="Enter X Solution Coordinate" class="form-control x2" value="{{ $ecardPhoto->x_solution_coordinate }}">
                        </div>    
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-lable">Y Solution Coordinate</label>
                            <input type="text" name="y_solution_coordinate" placeholder="Enter Y Solution Coordinate" class="form-control y2" value="{{ $ecardPhoto->y_solution_coordinate }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="x_message_coordinate" placeholder="Enter X Message Coordinate" class="form-control x3" value="{{ $ecardPhoto->x_message_coordinate }}">
                        </div>    
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-lable">Y Message Coordinate</label>
                            <input type="text" name="y_message_coordinate" placeholder="Enter Y Message Coordinate" class="form-control y3" value="{{ $ecardPhoto->y_message_coordinate }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="x_signature_coordinate" placeholder="Enter X Signature Coordinate" class="form-control x4" value="{{ $ecardPhoto->x_signature_coordinate }}">
                        </div>    
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-lable">Y Signature Coordinate</label>
                            <input type="text" name="y_signature_coordinate" placeholder="Enter Y Signature Coordinate" class="form-control y4" value="{{ $ecardPhoto->y_signature_coordinate }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row preview-parent">
            <div class="col-md-6">
                <div class="blank-image-preview-div">
                    <img src="{{ asset('/upload/ecard/blank/'.$ecardPhoto->blank_image) }}">
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="form-group">
            <div class="col-md-12 text-center">
                <input type="submit" value="Update Ecard Photo" class="btn btn-primary">
            </div>
        </div>
    </form>
</div>
