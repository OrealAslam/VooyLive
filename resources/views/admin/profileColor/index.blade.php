    ...
    $(document).ready(function(){
        ...
        $('#datatable01').DataTable({
            ...
            columns: [
                ...
                { data: 'sub_headings', name: 'sub_headings' },
                { data: 'footer', name: 'footer' },
                { data: 'background_1', name: 'background_1' },
                { data: 'background_2', name: 'background_2' },
                { data: 'icons_only', name: 'icons_only' },
