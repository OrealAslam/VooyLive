...
<div class="container">
    ...
    <div class="x_panel">
        <form action="{{ route('faq-question-answer.update',$faqQuestionAnswer->id) }}" enctype="multipart/form-data" method="post" class="col-lg-offset-1 col-lg-8">
            {{csrf_field()}}
            {{ method_field('PUT') }}
            <div class="row" style="margin-top:20px;">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="question" id=""class="form-control" value="{{ $faqQuestionAnswer->question }}" placeholder="Enter Answer">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="" class="control-label">Enter Answer</label>
                        <textarea class="form-control" name="description" rows="5" id="editor1">{!! $faqQuestionAnswer->description !!}</textarea>
                    </div>
                </div>
