...
<div class="container">
    ...
    <div class="x_panel">
        <form action="{{ route('faq-question-answer.store') }}" enctype="multipart/form-data" method="post" class="col-lg-offset-1 col-lg-8">
            {{csrf_field()}}
            ...
            <div class="row" style="margin-top:20px;">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="faq_question_title_id" value="{{ $id }}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
