...
<div class="container">
    <div class="row">
        <div class="x_title">
            <div class="col-md-6">
                <h2>Edit Faq Question Answer</h2>
            </div>
    ...
    <div class="x_panel">
        <form action="{{ route('fr-faq-question-answer.update',$frFaqQuestionAnswer->id) }}" enctype="multipart/form-data" method="post" class="col-lg-offset-1 col-lg-8">
            {{csrf_field()}}
            {{ method_field('PUT') }}
            <div class="row" style="margin-top:20px;">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="question" id=""class="form-control" value="{{ $frFaqQuestionAnswer->question }}" placeholder="Enter Answer">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="" class="control-label">Enter Answer</label>
                        <textarea class="form-control" name="description" rows="5" id="editor1">{!! $frFaqQuestionAnswer->description !!}</textarea>
                    </div>
                </div>
