                ...
                <div class="col-md-8 col-md-offset-2 col-xs-12">
                    <div class="cps-faq-accordion">
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            @if(!empty($frFaqQuestionTitles))
                                @foreach($frFaqQuestionTitles as $key=>$frFaqQuestionTitle)
                                    <h4>{{ $frFaqQuestionTitle->title }}</h4>
                                    @foreach($frFaqQuestionTitle->frFaqQuestionAnswer as $key=>$value)
